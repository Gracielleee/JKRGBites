...
public final class RestaurantRatingDao_Impl implements RestaurantRatingDao {
  ...
  public RestaurantRatingDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertAdapterOfRestaurantRating = new EntityInsertAdapter<RestaurantRating>() {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `restaurant_ratings` (`id`,`restaurantId`,`rating`,`comment`,`timestamp`) VALUES (?,?,?,?,?)";
      }
  ...
  public Object clearAndInsert(final List<RestaurantRating> ratings,
    ...
    return DBUtil.performInTransactionSuspending(__db, (_cont) -> {
      return RestaurantRatingDao.super.clearAndInsert(ratings, _cont);
    }, $completion);
  }
